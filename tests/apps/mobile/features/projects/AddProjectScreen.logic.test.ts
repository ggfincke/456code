// tests/apps/mobile/features/projects/AddProjectScreen.logic.test.ts
// verifies connected environment selection for mobile project creation

import type { EnvironmentConnectionPhase } from '@t3tools/client-runtime/connection'
import { EnvironmentId } from '@t3tools/contracts'
import { describe, expect, it } from 'vite-plus/test'

import { resolveAddProjectEnvironment } from '../../../../../apps/mobile/src/features/projects/AddProjectScreen.logic'
