// tests/apps/mobile/features/terminal/threadTerminalPanelModel.test.ts
// verify thread terminal subscription key behavior
...
} from '../../../../../apps/mobile/src/features/terminal/threadTerminalPanelModel'
