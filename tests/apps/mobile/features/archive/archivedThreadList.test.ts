...
import { buildArchivedThreadGroups } from '../../../../../apps/mobile/src/features/archive/archivedThreadList'
...
describe('buildArchivedThreadGroups', () =>
{
  ...
  {
    const project = makeProject({ id: ProjectId.make('project-1'), title: '456code' })
  ...
  it('filters by environment and matches project, thread, and branch text', () =>
  {
    ...
    const firstProject = makeProject({ id: ProjectId.make('project-1'), title: '456code' })
