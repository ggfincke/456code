...
import type { ConnectedEnvironmentSummary } from '../../../../../apps/mobile/src/state/remote-runtime-types'
import { splitEnvironmentSections } from '../../../../../apps/mobile/src/features/connection/environmentSections'
