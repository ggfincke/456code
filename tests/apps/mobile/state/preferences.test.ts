...
vi.mock("../../../../apps/mobile/src/lib/runtime", async () => {
...
import type { Preferences } from "../../../../apps/mobile/src/persistence/mobile-preferences";
import {
  createMobilePreferencesState,
  MobilePreferencesLoadError,
  MobilePreferencesSaveError,
  MobilePreferencesStore,
} from "../../../../apps/mobile/src/state/preferences";
