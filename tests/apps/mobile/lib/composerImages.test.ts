...
} from '../../../../apps/mobile/src/lib/composerImages'
...
describe('native pasted image cleanup', () =>
{
  ...
  it('recognizes only files created in the native composer paste directory', () =>
  {
    expect(
      isOwnedPastedImageUri(
        'file:///private/var/mobile/Containers/Data/Application/app/tmp/code456-composer-paste/id.png',
      ),
    ).toBe(true)
    expect(isOwnedPastedImageUri('file:///private/var/mobile/photos/id.png')).toBe(false)
    expect(isOwnedPastedImageUri('https://example.com/code456-composer-paste/id.png')).toBe(false)
  })
  ...
  {
    const rejected =
      'file:///private/var/mobile/Containers/Data/Application/app/tmp/code456-composer-paste/bad.png'
    const overflow =
      'file:///private/var/mobile/Containers/Data/Application/app/tmp/code456-composer-paste/overflow.png'
