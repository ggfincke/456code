// tests/apps/mobile/components/projectFaviconCache.test.ts
// verifies mobile favicon request supersession and bounded caching
...
} from "../../../../apps/mobile/src/components/projectFaviconCache";
