...
import { DesktopLifecycleRelaunchError } from '../../../../apps/desktop/src/app/DesktopLifecycle.ts'
import { DesktopApplicationMenuActionError } from '../../../../apps/desktop/src/window/DesktopApplicationMenu.ts'
