// tests/apps/web/components/chat/changedFilesPresentation.test.ts
// verify changed files presentation behavior
...
} from '../../../../../apps/web/src/components/chat/changedFilesPresentation'
