// tests/apps/web/components/chat/composerContextWindow.test.ts
...
import { selectThreadContextWindowSnapshot } from '../../../../../apps/web/src/components/chat/composerContextWindow'
