// tests/apps/web/components/chat/composer/ChatComposer.logic.test.ts
// verifies composer prompt-ref synchronization around pending user input
import { describe, expect, it } from 'vite-plus/test'

import { resolvePendingInputPromptSync } from '../../../../../../apps/web/src/components/chat/composer/pendingInputPromptSync'
