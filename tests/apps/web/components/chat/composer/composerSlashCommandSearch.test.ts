// tests/apps/web/components/chat/composer/composerSlashCommandSearch.test.ts
// verify search slash command items behavior

import { describe, expect, it } from 'vite-plus/test'
import { ProviderDriverKind } from '@t3tools/contracts'

import type { ComposerCommandItem } from '../../../../../../apps/web/src/components/chat/composer/ComposerCommandMenu'
import { searchSlashCommandItems } from '../../../../../../apps/web/src/components/chat/composer/composerSlashCommandSearch'
