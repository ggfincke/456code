// tests/apps/web/components/chat/composer/composerMenuHighlight.test.ts
// verify resolve composer menu active item id behavior

import { describe, expect, it } from 'vite-plus/test'

import { resolveComposerMenuActiveItemId } from '../../../../../../apps/web/src/components/chat/composer/composerMenuHighlight'
