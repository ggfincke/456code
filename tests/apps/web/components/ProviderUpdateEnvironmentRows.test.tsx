...
} from '../../../../apps/web/src/components/ProviderUpdateLaunchNotification.logic'
...
vi.mock(
  '../../../../apps/web/src/components/ProviderUpdateLaunchNotification.environments',
  () => ({
...
import { ProviderUpdateEnvironmentRows } from '../../../../apps/web/src/components/ProviderUpdateEnvironmentRows'
