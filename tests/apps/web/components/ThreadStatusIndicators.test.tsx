...
import { ThreadWorktreeIndicator } from '../../../../apps/web/src/components/ThreadStatusIndicators'
...
describe('ThreadWorktreeIndicator', () =>
{
  it('renders the worktree folder and branch in an accessible label', () =>
  {
    ...
    expect(markup).toContain('aria-label="Worktree: sidebar-indicator (feature/sidebar-indicator)"')
