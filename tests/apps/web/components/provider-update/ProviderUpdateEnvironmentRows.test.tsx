// tests/apps/web/components/provider-update/ProviderUpdateEnvironmentRows.test.tsx
...
} from '../../../../../apps/web/src/components/provider-update/ProviderUpdateLaunchNotification.logic'
...
vi.mock(
  '../../../../../apps/web/src/components/provider-update/ProviderUpdateLaunchNotification.environments',
  () => ({
...
import { ProviderUpdateEnvironmentRows } from '../../../../../apps/web/src/components/provider-update/ProviderUpdateEnvironmentRows'
