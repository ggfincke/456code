// tests/apps/web/components/ProjectFavicon.test.tsx
// verifies web favicon refresh and fallback behavior
...
import { ProjectFavicon } from "../../../../apps/web/src/components/ProjectFavicon";
