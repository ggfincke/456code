// tests/apps/web/lib/markdown/links.test.ts
...
describe('rewriteMarkdownFileUriHref', () =>
{
  ...
  it('unwraps angle-bracketed file uri hrefs', () =>
  {
    expect(
      rewriteMarkdownFileUriHref(
        ' <file:///D:/Programme/t3code/apps/web/src/lib/markdown/links.ts> ',
      ),
    ).toBe('D:/Programme/t3code/apps/web/src/lib/markdown/links.ts')
  })
})
