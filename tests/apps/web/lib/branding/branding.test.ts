// tests/apps/web/lib/branding/branding.test.ts
...
} from '../../../../../apps/web/src/lib/branding/branding.logic'
...
describe('branding', () =>
{
  it('uses injected desktop branding when available', async () =>
  {
    ...
    const branding = await import('../../../../../apps/web/src/lib/branding/branding')
