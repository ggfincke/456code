// tests/apps/web/connection/hostedPairing.test.ts
...
} from '../../../../apps/web/src/connection/hostedPairing'
...
describe('hostedPairing', () =>
{
  ...
  it('builds hosted channel selection URLs through the configured router origin', () =>
  {
    ...
    expect(url.pathname).toBe('/__456code/channel')
  ...
  it('ignores incomplete hosted pairing requests', () =>
  {
    ...
    expect(hasHostedPairingRequest(new URL('https://app.t3.codes/pair?token=ABCD1234'))).toBe(false)
  })
