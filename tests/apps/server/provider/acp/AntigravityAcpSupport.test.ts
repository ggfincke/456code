// tests/apps/server/provider/acp/AntigravityAcpSupport.test.ts
// verifies official Antigravity ACP identity, model, prompt, and attachment boundaries
...
} from '../../../../../apps/server/src/provider/acp/AntigravityAcpSupport.ts'
  ...
  it.effect('sends supported audio files as native audio content', () =>
    Effect.gen(function* ()
    {
      ...
      const audioAttachment = {
        ...textAttachment,
        id: 'thread-00000000-0000-4000-8000-000000000004-wav',
        name: 'recording.wav',
        mimeType: 'audio/wav',
      } satisfies ChatAttachment
  ...
  it.effect('accepts 50 MiB in total but rejects one byte more across files', () =>
    Effect.gen(function* ()
    {
      ...
      const secondAttachment = {
        ...pdfAttachment,
        id: 'thread-00000000-0000-4000-8000-000000000005-pdf',
        name: 'second.pdf',
      }
