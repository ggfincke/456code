// tests/apps/server/provider/acp/AntigravityProtocol.test.ts
// verifies Antigravity ACP normalization, approvals, and subagent classification
...
} from '../../../../../apps/server/src/provider/acp/AntigravityProtocol.ts'
import {
  mergeToolCallState,
