// tests/apps/server/provider/antigravityCallback.test.ts
// verifies exact Google OAuth loopback callback validation
...
import { validateAntigravityCallbackUrl } from '../../../../apps/server/src/provider/antigravityCallback.ts'
