...
} from "../../../../apps/server/src/orchestration/ActivityPayloadProjection.ts";
...
describe("projectActivityPayload", () => {
  ...
  it("keeps image paths while pruning generated image bytes", () => {
    const generated = projectedItem(
      projectActivityPayload(
        makeImageActivity({
          id: "call-1",
