...
} from '../../../../packages/client-runtime/src/authorization/remote.ts'
import { fetchRemoteEnvironmentDescriptor } from '../../../../packages/client-runtime/src/environment/descriptor.ts'
