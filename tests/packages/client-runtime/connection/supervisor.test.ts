// tests/packages/client-runtime/connection/supervisor.test.ts
// covers supervised connection retries and wakeups
...
import type { ConnectionCatalogEntry } from '../../../../packages/client-runtime/src/connection/catalog.ts'
