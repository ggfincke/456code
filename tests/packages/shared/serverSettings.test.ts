// tests/packages/shared/serverSettings.test.ts
...
import { createModelSelection } from '../../../packages/shared/src/model.ts'
import {
...
describe('serverSettings helpers', () =>
{
  ...
  it('falls back from a disabled source control writer provider without clearing its selection', () =>
  {
    ...
    expect(isModelSelectionProviderEnabled(settings, sourceControlWriterModelSelection)).toBe(false)
