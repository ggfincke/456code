...
import {
  ...
  postDiscordWebhook,
} from '../../scripts/notify-discord-release.ts'

const latestAnnouncement = {
  target: 'latest',
  roleId: '222222222222222222',
  releaseName: '456code v1.2.3',
  version: '1.2.3',
  tag: 'v1.2.3',
...
it('builds a prerelease Discord announcement for nightly subscribers', () =>
{
  assert.deepStrictEqual(
    ...
    }),
    {
      ...
      embeds: [
        {
          title: '456code Nightly 1.2.4-nightly.20260501.17 (abcdef123456)',
          url: 'https://github.com/t3dotgg/t3-code/releases/tag/v1.2.4-nightly.20260501.17',
          description: 'A new 456code prerelease is available for nightly testers.',
          color: 0x5865f2,
          fields: [
            {
              name: 'Version',
