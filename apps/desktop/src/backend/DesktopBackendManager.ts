...
type BackendProcessError =
  BackendProcessBootstrapEncodeError | BackendProcessSpawnError | BackendTimeoutError
      ...
      Effect.gen(function* ()
      {
        ...
        if (Option.isSome(preflightFailure))
        {
          ...
          if (attempt === attemptLimit)
          {
            ...
            const shouldRestart = yield* spec.onPreflightFailed?.(preflightFailure.value) ??
