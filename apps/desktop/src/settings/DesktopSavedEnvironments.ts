...
const SavedEnvironmentRegistryDocumentJson = fromLenientJson(SavedEnvironmentRegistryDocumentSchema)
...
export type DesktopSavedEnvironmentsReadRegistryError =
  DesktopSavedEnvironmentsReadError | DesktopSavedEnvironmentsDocumentDecodeError

export type DesktopSavedEnvironmentsMutationError =
  DesktopSavedEnvironmentsReadRegistryError | DesktopSavedEnvironmentsWriteError
...
export type DesktopSavedEnvironmentsSetSecretError =
  DesktopSavedEnvironmentsMutationError | DesktopSavedEnvironmentSecretProtectionError
