...
// oxlint-disable-next-line 456code/no-global-process-runtime -- Standalone dev script has no Effect runtime.
...
function cleanupStaleDevApps()
{
  ...
  NodeChildProcess.spawnSync('pkill', ['-f', '--', `--456code-dev-root=${desktopDir}`], {
    stdio: 'ignore',
  })
}
...
function startApp()
{
  ...
  const launchArgs = devProtocolClient
    ? electronArgs
    : [...electronArgs, `--456code-dev-root=${desktopDir}`, 'dist-electron/main.cjs']
