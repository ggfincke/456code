...
- `development`: Expo dev client, installable side-by-side as `456code Dev`
- `preview`: persistent internal preview build, installable side-by-side as `456code Preview`
- `production`: store/release build as `456code`

Run commands from `apps/mobile`.

Cloud relay access is optional and disabled in a fresh clone. Public configuration belongs in the
