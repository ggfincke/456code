// apps/mobile/src/features/threads/composer/ComposerCommandPopover.tsx
...
})
{
  ...
  return (
    ...
    >
      ...
      <Text className="shrink-0 text-base font-sans-medium text-foreground" numberOfLines={1}>
        {props.item.label}
      </Text>
