// apps/mobile/src/features/threads/activity/thread-work-log.tsx
...
})
{
  ...
  return (
    <View className="-mx-1 mb-1 px-1 py-0">
      {!onlyToolRows ? (
        <Text className="px-0.5 pb-0.5 font-sans-medium text-2xs text-foreground-muted opacity-60">
          work log
        </Text>
      ) : null}
  ...
  return (
    <View className="-mx-1 mb-1 px-1 py-0">
      ...
      >
        ...
        <Text className="font-sans-medium text-xs text-foreground opacity-80">
