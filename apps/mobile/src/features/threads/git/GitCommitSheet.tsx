  ...
  return (
    <View collapsable={false} className="flex-1 bg-sheet">
      ...
      >
        ...
        <View className="gap-3 rounded-[22px] border border-border bg-card px-4 py-4">
          <View className="flex-row items-center justify-between gap-3">
            <View className="gap-1">
              <Text className="text-foreground text-base font-sans-bold">Files</Text>
            ...
            <View className="flex-row items-center gap-2">
              {!allSelected && isEditingFiles ? (
                ...
                >
                  <Text className="text-foreground text-2xs font-sans-bold uppercase">Reset</Text>
                </Pressable>
              ) : null}
              <Pressable
                className="bg-subtle rounded-full px-3 py-2"
            ...
            <View className="gap-2">
              {selectedFilePreview.map((file) => (
                <View key={file.path} className="flex-row items-center justify-between gap-3">
                  ...
                  <Text className="text-xs font-sans-bold text-emerald-500">
                    +{file.insertions}
                  </Text>
                  <Text className="text-xs font-sans-bold text-rose-500">-{file.deletions}</Text>
                </View>
              ))}
                  ...
                  >
                    ...
                    <View className="flex-row items-start justify-between gap-3">
                      ...
                      <View className="items-end gap-1">
                        ...
                        <Text className="text-xs font-sans-bold text-rose-500">
                          -{file.deletions}
                        </Text>
                      </View>
                    </View>
        ...
        <View className="gap-2">
          <Text className="text-foreground text-sm font-sans-bold">Commit message</Text>
          <TextInput
            multiline
