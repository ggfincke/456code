...
// capture and resolve assistant quotes against stable normalized DOM text
...
// keep exact selected text with normalized UTF-16 offsets and bounded context
...
// resolve a selector only when its quote and context identify one normalized match
...
// read stable DOM text order while excluding controls and hidden subtrees
...
// capture the ordered native range, including selections dragged backwards
...
// resolve against the current DOM without changing the user's selection
