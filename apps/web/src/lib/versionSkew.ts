// apps/web/src/lib/versionSkew.ts
...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = '456code:version-mismatch-dismissals:v1'
...
): string
{
  switch (capability)
  {
    ...
    case 'desktop-managed':
      return `The ${serverLabel} is run by the 456code desktop app on its machine — update the desktop app there to sync them.`
    default:
