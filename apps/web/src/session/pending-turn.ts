...
// derives unresolved approval and user input requests
...
): PendingApproval[]
{
  ...
  // durable outcomes are authoritative over the activity stream: terminal ones close the
  // request, non-terminal ones decorate it w/ the response status the user already sent
