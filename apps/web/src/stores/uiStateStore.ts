// apps/web/src/stores/uiStateStore.ts
...
export const PERSISTED_STATE_KEY = '456code:ui-state:v1'
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1
const LEGACY_PERSISTED_STATE_KEYS = [
  '456code:renderer-state:v8',
  '456code:renderer-state:v7',
  '456code:renderer-state:v6',
  '456code:renderer-state:v5',
  '456code:renderer-state:v4',
  '456code:renderer-state:v3',
