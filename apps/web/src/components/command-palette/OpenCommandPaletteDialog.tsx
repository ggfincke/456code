// apps/web/src/components/command-palette/OpenCommandPaletteDialog.tsx
// render the open command palette dialog and add-project flows
...
import { resolveEnvironmentOptionLabel } from '../branch-toolbar/BranchToolbar.logic'
