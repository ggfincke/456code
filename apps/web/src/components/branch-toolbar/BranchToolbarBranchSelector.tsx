// apps/web/src/components/branch-toolbar/BranchToolbarBranchSelector.tsx
// selects and creates refs for thread worktrees
      ...
      <div className={cn('flex min-w-0 items-center gap-1', className)}>
        ...
        >
          <ComboboxTrigger
            ...
            className="min-w-0 max-w-full text-muted-foreground/70 hover:text-foreground/80 active:scale-100"
