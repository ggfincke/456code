...
const LAST_ENABLED_PROJECT_GROUPING_MODE_KEY = '456code:last-enabled-project-grouping-mode'
...
export function buildProviderInstanceUpdatePatch(input: {
  ...
  readonly textGenerationModelSelection?: ServerSettings['textGenerationModelSelection'] | undefined
