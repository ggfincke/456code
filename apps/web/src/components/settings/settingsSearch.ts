...
export const SETTINGS_SEARCH_ITEMS: ReadonlyArray<SettingsSearchItem> = [
  ...
  },
  {
    ...
    to: '/settings/usage',
    keywords: ['usage', 'quota', 'codex', 'claude', 'reset'],
  },
  {
    id: 'usage-cost',
    title: 'Usage and cost',
    to: '/settings/usage',
    keywords: ['tokens', 'pricing', 'transcripts'],
  },
  {
    id: 'usage-model-pricing',
    title: 'Model pricing',
    to: '/settings/usage',
    anchorId: 'usage-model-pricing',
    keywords: ['custom rates', 'cost override'],
  },
  {
    id: 'browser',
    title: 'Browser',
