...
const RPC_REQUIRED_SCOPE = new Map<string, AuthEnvironmentScope>([
  ...
  [ORCHESTRATION_WS_METHODS.getRunDiff, AuthOrchestrationReadScope],
  [ORCHESTRATION_WS_METHODS.getRunExecutionDiffV1, AuthOrchestrationReadScope],
  ...
  [WS_METHODS.proposalsFindByOrchestrateRevision, AuthOrchestrationReadScope],
  ...
  [WS_METHODS.cartographerEnsureProjectArchitecture, AuthOrchestrationOperateScope],
  [WS_METHODS.cartographerRebuildProjectAtlas, AuthOrchestrationOperateScope],
  [WS_METHODS.cartographerPrepareCurrentWorktreeArchitecture, AuthOrchestrationOperateScope],
  [WS_METHODS.cartographerRequestDiffAnalysis, AuthOrchestrationOperateScope],
  [WS_METHODS.cartographerGetDiffAnalysis, AuthOrchestrationReadScope],
  [WS_METHODS.cartographerGetArchitectureImpactProjection, AuthOrchestrationReadScope],
