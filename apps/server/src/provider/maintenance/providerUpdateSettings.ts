// apps/server/src/provider/maintenance/providerUpdateSettings.ts
...
{
  const mapSettings = (settings: ServerSettings) => makeProviderSnapshotSettings(provider, settings)
  return {
