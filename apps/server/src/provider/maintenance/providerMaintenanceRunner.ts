...
>()('456code/provider/maintenance/providerMaintenanceRunner')
{}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? 'Update command completed, but 456code could not verify the provider version.'
                  : stillOutdated
                    ? 'Update command completed, but 456code still detects an outdated provider version.'
                    : 'Provider updated.',
                output: commandOutput(result),
              }),
            )
