...
interface SkillRoot
{
  ...
  readonly scope: ServerProviderSkill['scope']
}

const discoverAntigravitySkillRoots = Effect.fn('discoverAntigravitySkillRoots')(function* (
...
>
{
  ...
  const scanDirectory = Effect.fn('scanAntigravitySkillDirectory')(function* (
    directory: string,
    scope: ServerProviderSkill['scope'],
