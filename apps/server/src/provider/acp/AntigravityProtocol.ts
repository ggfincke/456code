...
// normalizes Antigravity ACP protocol details for the provider adapter
...
// ACP 1.1.1 exposes subagent batches as ordinary tools without child IDs or models.
...
// history sends a completed start before the separate batch output and final status.
