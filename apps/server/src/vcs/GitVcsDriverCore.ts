...
// implements git-backed version control operations
...
} from './GitVcsPorcelainParse.ts'
import { statusUpstreamRefreshFailureCooldown } from './GitVcsStatusUpstream.ts'
...
// re-export for existing Core test imports of the null-path helper
export { splitNullSeparatedGitStdoutPaths } from './GitVcsPorcelainParse.ts'
...
>
{
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `456code-git-trace2-${process.pid}-`,
    suffix: '.json',
  })
