// apps/server/src/git/GitManagerActionPresentation.ts
// toast, progress, and commit-message presentation helpers

import type { GitRunStackedActionResult, GitStackedAction } from '@t3tools/contracts'
import type { ChangeRequestTerminology } from '@t3tools/shared/sourceControl'
