...
>()('456code/environment/ServerEnvironment')
{}
...
export const make = Effect.gen(function* ()
{
  ...
  const descriptor: ExecutionEnvironmentDescriptor = {
    ...
    // serverSelfUpdate is deliberately absent: this build has no self-update
    // path, so clients must offer a manual relaunch.
    capabilities: {
