...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.subscribeProjectAtlasStatus
  | typeof WS_METHODS.workersSubscribe
  | typeof WS_METHODS.workersSubscribeActivity
  | typeof WS_METHODS.terminalAttach

export type EnvironmentStreamCommandRpcTag =
  typeof WS_METHODS.cloudInstallRelayClient | typeof WS_METHODS.gitRunStackedAction

export type EnvironmentStreamRpcTag = EnvironmentSubscriptionRpcTag | EnvironmentStreamCommandRpcTag
            ...
            Option.match({
              ...
              onSome: (session) =>
              {
                ...
                > =>
                  Stream.suspend(() =>
                    Stream.unwrap(
                      makeInput(session).pipe(Effect.map((input) => method(input))),
                    ).pipe(
