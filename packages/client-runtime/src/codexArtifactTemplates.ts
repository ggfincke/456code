...
// validates Codex artifact template directives and builds reusable follow-up prompts
...
// mirror the Codex result-card schema so malformed directives remain literal markdown
