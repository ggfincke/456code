...
// parses only supported Codex directives for web, native, and clipboard rendering
...
// add grammar only for the two directives emitted by Codex, then render them as mdast
...
// native markdown renderers cannot consume a remark tree
...
// match the markdown emitted when users copy rendered Codex directive UI
...
// native renderers split cards out because markdown text cannot host a view
