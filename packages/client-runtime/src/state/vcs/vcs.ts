// packages/client-runtime/src/state/vcs/vcs.ts
// manages reactive version control state
...
{
  // one flat family keeps the family owner retained across paginated lookups;
  // individual page atoms remain weakly held and can expire independently.
