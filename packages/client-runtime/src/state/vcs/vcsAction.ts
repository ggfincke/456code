// packages/client-runtime/src/state/vcs/vcsAction.ts
// runs serialized version control actions
...
{
  return Atom.make(EMPTY_VCS_ACTION_STATE).pipe(Atom.keepAlive, Atom.withLabel(`vcs-action:${key}`))
})
