// packages/client-runtime/src/state/projects/projectEntities.ts
...
import type { EnvironmentProject } from '../session/models.ts'
import { scopeProject } from '../session/models.ts'
