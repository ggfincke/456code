// packages/client-runtime/src/state/threads/threadShell.ts
...
import type { EnvironmentThreadShell } from '../session/models.ts'
import { scopeThreadShell } from '../session/models.ts'
import type { EnvironmentCatalogState } from '../connection-state/connections.ts'
import {
  arrayElementsEqual,
