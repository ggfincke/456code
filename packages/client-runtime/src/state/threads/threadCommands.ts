// packages/client-runtime/src/state/threads/threadCommands.ts
...
import {
  ...
  type SetThreadWorkerVerdictInput,
...
)
{
  ...
  return {
    ...
    setWorkerVerdict: createEnvironmentCommand(runtime, {
      label: 'environment-data:commands:thread:set-worker-verdict',
      execute: (input: SetThreadWorkerVerdictInput) => setThreadWorkerVerdict(input),
      scheduler,
      concurrency,
    }),
