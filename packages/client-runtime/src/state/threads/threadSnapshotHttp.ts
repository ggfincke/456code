// packages/client-runtime/src/state/threads/threadSnapshotHttp.ts
...
} from '../connection-state/environmentHttpAuth.ts'
...
>()('@t3tools/client-runtime/state/threads/threadSnapshotHttp/ThreadSnapshotLoader')
{}
