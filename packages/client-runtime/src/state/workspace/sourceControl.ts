// packages/client-runtime/src/state/workspace/sourceControl.ts
...
import { vcsCommandConcurrency, vcsCommandScheduler } from '../vcs/vcsCommandScheduler.ts'
import { invalidateCachedVcsRefs } from '../vcs/vcsRefInvalidation.ts'
