...
export type SessionCloseCapabilities = { readonly _meta?: { readonly [x: string]: unknown } | null }
...
export type NesOpenFilesCapabilities = { readonly _meta?: { readonly [x: string]: unknown } | null }
...
export type AgentResponse =
  ...
  | {
      ...
      readonly error: {
        readonly code:
          -32700 | -32600 | -32601 | -32602 | -32603 | -32800 | -32000 | -32002 | number
        readonly message: string
...
}).annotate({ description: 'All text that was typed after the command name is provided as input.' })
