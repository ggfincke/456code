// packages/shared/src/pierreFileIcons.ts
// owns neutral custom pierre file icon data shared by web and mobile

export const PIERRE_CUSTOM_FILE_ICON_SPRITE = `
...
export const PIERRE_CUSTOM_FILE_ICON_BY_FILE_NAME = {
...
export const PIERRE_MOBILE_CUSTOM_ICON_BY_TOKEN = {
