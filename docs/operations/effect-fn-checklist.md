...
- [x] [makeGitVcsDriverCore](../../apps/server/src/vcs/GitVcsDriverCore.ts#L791)
- [x] [handleTraceLine](../../apps/server/src/vcs/GitVcsDriverCore.ts#L555)
- [x] [emitCompleteLines](../../apps/server/src/vcs/GitVcsDriverCore.ts#L716)
- [x] [commit](../../apps/server/src/vcs/GitVcsDriverCore.ts#L1957)
- [x] [pushCurrentBranch](../../apps/server/src/vcs/GitVcsDriverCore.ts#L1992)
- [x] [pullCurrentBranch](../../apps/server/src/vcs/GitVcsDriverCore.ts#L2125)
- [x] [switchRef](../../apps/server/src/vcs/GitVcsDriverCore.ts#L2925) (successor of former `checkoutBranch`)
- [x] Service methods and callback wrappers in this file

### `apps/server/src/git/GitManager.ts` (`28`)

- [x] [configurePullRequestHeadUpstream](../../apps/server/src/git/GitManager.ts#L758)
- [x] [materializePullRequestHeadBranch](../../apps/server/src/git/GitManager.ts#L834)
- [x] [findOpenPr](../../apps/server/src/git/GitManager.ts#L1285)
- [x] [findLatestPrForHeadContext](../../apps/server/src/git/GitManager.ts#L1327)
- [x] [runCommitStep](../../apps/server/src/git/GitManager.ts#L1568)
- [x] [runPrStep](../../apps/server/src/git/GitManager.ts#L1691)
- [x] [runFeatureBranchStep](../../apps/server/src/git/GitManager.ts#L2181)
...
- [ ] [apps/server/src/orchestration/Layers/CheckpointDiffQuery.ts](../../apps/server/src/orchestration/Layers/CheckpointDiffQuery.ts) (`2`)
- [ ] [apps/server/src/provider/catalog/makeManagedServerProvider.ts](../../apps/server/src/provider/catalog/makeManagedServerProvider.ts) (`1`)
