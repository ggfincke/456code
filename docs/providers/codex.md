...
This guide is for people who want to use more than one Codex account in 456code.
...
In 456code Settings, name it something obvious:
...
In 456code Settings, add another Codex provider:
...
456code shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, 456code treats it
